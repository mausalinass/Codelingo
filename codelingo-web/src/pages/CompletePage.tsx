...
export const CompletePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4 sm:p-6 text-slate-900 selection:bg-red-500 selection:text-white">
      <div className="w-full max-w-md flex flex-col items-center text-center gap-6">
        ...
        <div className="grid grid-cols-2 gap-4 w-full">
          ...
          <motion.div
            ...
            className="p-4 rounded-2xl bg-orange-50 border-2 border-orange-200 flex flex-col items-center shadow-xs"
          >
            <motion.div
            ...
            <div className="text-[11px] font-bold text-orange-700/80 uppercase tracking-wide">
              Daily Streak 🔥
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="p-4 rounded-2xl bg-amber-50 border-2 border-amber-200 flex flex-col items-center shadow-xs"
          >
            <motion.div
            ...
            <div className="text-[11px] font-bold text-amber-700/80 uppercase tracking-wide">
              Earned Points ⚡
            </div>
          </motion.div>
        </div>
