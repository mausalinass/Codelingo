  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="flex items-center gap-2 px-3 py-1.5 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 transition-all font-bold text-slate-800 shadow-xs active:scale-98 cursor-pointer focus:outline-hidden focus:ring-2 focus:ring-red-500/20"
        aria-label="Select Programming Language"
      >
        <span className="flex items-center justify-center w-6 h-6 rounded-lg bg-slate-900 text-white font-mono text-xs font-bold shrink-0">
          {activeLang.badge}
        </span>
      ...
      {isOpen && (
        <div className="absolute left-0 mt-2 w-72 sm:w-80 rounded-2xl bg-white border border-slate-200 shadow-2xl py-2 z-50 animate-in fade-in slide-in-from-top-2 duration-150 max-h-[440px] overflow-y-auto">
          <div className="px-3.5 py-2 border-b border-slate-100 flex items-center justify-between text-xs text-slate-500">
            ...
            <span className="font-bold flex items-center gap-1 text-red-600 bg-red-50 px-2 py-0.5 rounded-md">
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-xs text-slate-500 truncate mt-0.5">{lang.description}</div>
                  </div>
                  {isSelected && (
