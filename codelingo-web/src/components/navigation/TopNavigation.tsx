      ...
      <header className="sticky top-0 z-40 w-full bg-white/95 dark:bg-slate-900/95 backdrop-blur-xs border-b border-slate-200 dark:border-slate-800 transition-colors">
        <div className="max-w-6xl xl:max-w-7xl mx-auto px-4 sm:px-6 min-h-16 py-2 sm:py-0 flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <div className="w-9 h-9 group-hover:scale-105 transition-all shrink-0 flex items-center justify-center">
                <img
          ...
          <div className="w-full sm:w-auto flex items-center justify-between sm:justify-start gap-2 sm:gap-3">
            ...
            >
              ...
              <span className="hidden sm:inline">{uiText(onboarding.uiLanguage, "demoProfile")}</span>
            </button>
            ...
            <button
              type="button"
              onClick={() => setIsModalOpen(true)}
              className="hidden w-9 h-9 rounded-full bg-slate-100 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 hover:border-slate-400 sm:flex items-center justify-center text-xs font-bold text-slate-700 dark:text-slate-200 shadow-2xs select-none transition-colors cursor-pointer"
