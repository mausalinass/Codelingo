...
public sealed record EvaluateResponse(bool Correct, int XpAwarded, FeedbackDto Feedback, EvaluationProgress Progress, EvaluationStreak Streak, int AttemptNumber, bool AdvanceRequired, string? CorrectAnswer, int ProblemsResolved, int TotalProblems);
